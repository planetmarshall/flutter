...
#include "impeller/entity/recursive_blur.frag.h"
...
using RecursiveBlurPipeline = RenderPipelineHandle<FilterPositionUvVertexShader, RecursiveBlurFragmentShader>;
